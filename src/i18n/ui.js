...
export const ui = {
  ...
  de: {
    ...
    aff_p: 'GHC zu kompilieren und Ihre App auszuführen verlangt einen echten Linux-Server. Infomaniak - ein schweizerischer, datenschutzfreundlicher Hoster - bietet dafür VPS und Cloud-Server.',
    aff_cta: 'Infomaniak Cloud ansehen →',
    art_aff_h: 'Brauchen Sie einen Server, um Haskell zu bauen und auszuführen?',
    art_aff_p: 'GHC zu kompilieren und Ihre App auszuführen läuft auf einem echten Linux-Server reibungsloser. Infomaniak (schweizerisch, datenschutzfreundlich) bietet dafür VPS und Cloud-Server.',
  ...
  it: {
    ...
    aff_p: 'Compilare GHC ed eseguire la tua app richiede una vera macchina Linux. Infomaniak - un host svizzero rispettoso della privacy - offre VPS e server cloud per questo.',
    aff_cta: 'Scopri il cloud Infomaniak →',
    art_aff_h: 'Ti serve una macchina per compilare ed eseguire Haskell?',
    art_aff_p: 'Compilare GHC ed eseguire la tua app è più semplice su un vero server Linux. Infomaniak (svizzero, rispettoso della privacy) offre VPS e server cloud per questo.',
  ...
  pt: {
    ...
    aff_p: 'Compilar o GHC e executar a sua aplicação exige uma verdadeira máquina Linux. A Infomaniak - um alojamento suíço que respeita a privacidade - oferece VPS e servidores cloud para isso.',
    aff_cta: 'Ver o cloud da Infomaniak →',
    art_aff_h: 'Precisa de uma máquina para compilar e executar Haskell?',
    art_aff_p: 'Compilar o GHC e executar a sua aplicação é mais simples num verdadeiro servidor Linux. A Infomaniak (suíça, que respeita a privacidade) oferece VPS e servidores cloud para isso.',
